"""
Django settings for mailling_service project.
...
SECRET_KEY = 'django-insecure-6j=^0!q*&pdpw@+k7wfma-zo1x*0n$+6jyycn$j70=1!#(#$mb'
...
ROOT_URLCONF = 'mailling_service.urls'
...
WSGI_APPLICATION = 'mailling_service.wsgi.application'
